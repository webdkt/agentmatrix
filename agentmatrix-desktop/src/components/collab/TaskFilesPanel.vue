...
const emit = defineEmits(['open-entry', 'go-up', 'go-root', 'select-file', 'contextmenu', 'hide-context-menu', 'menu-action'])
...
<template>
  <div class="task-files-panel" data-drop-zone="task-files" @click="emit('hide-context-menu')">
    <!-- Breadcrumb -->
